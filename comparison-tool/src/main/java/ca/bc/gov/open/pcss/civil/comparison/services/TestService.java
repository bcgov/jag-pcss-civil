...
public class TestService {
  ...
  private void getFileDetailCivilCompare(List<Boolean> compares) {
    ...
    InputStream inputIds = getClass().getResourceAsStream("/getFileDetailCivilPhysicalFileId.csv");
    ...
    System.out.println("INFO: GetFileDetailCivil Completed there are " + compares.size() + "diffs");
  }
